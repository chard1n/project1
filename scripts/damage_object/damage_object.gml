function damage_object(obj, damage = 0){
	...
	if(instance_exists(obj)) {
		if(variable_instance_exists(obj, "oHealth") && variable_instance_exists(obj, "isHurt") && variable_instance_exists(obj, "invincibilityTimer") && variable_instance_exists(obj, "invincibilityTimeMax")) {
